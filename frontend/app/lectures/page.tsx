...
import { VideoCameraOutlined, UserOutlined, CalendarOutlined, PlayCircleOutlined, PlusOutlined } from '@ant-design/icons';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center mb-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-2">실시간 강의</h1>
              <p className="text-gray-600">진행 중인 강의에 참여하거나 새로운 강의를 만드세요</p>
            </div>
        ...
        {filteredLectures.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400">검색 조건을 변경하거나 새로운 강의를 만들어보세요</p>
          </div>
        )}
      </div>
    </div>
